...
/**
 * 护理人员职称信息对象 nmis_hr_title
 *
 * @author ydl
 * @date 2025-03-04
 */
public class NmisHrTitleWithDept extends BaseEntity {
    ...
    @Excel(name = "取得职称时间", width = 30, dateFormat = "yyyy-MM-dd")
