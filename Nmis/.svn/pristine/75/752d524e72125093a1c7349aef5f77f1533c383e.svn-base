...
/**
 * 护理人员外派信息对象 nmis_hr_expatriate
 *
 * @author ydl
 * @date 2025-03-12
 */
public class NmisHrExpatriate extends BaseEntity
{
    ...
    /** 调出科室ID */
    @Excel(name = "调出科室ID")
    @NotBlank(message = "调出科室id不能为空")
    private String srcDeptId;

    /** 调出科室名称 */
    @Excel(name = "调出科室名称")
    @NotBlank(message = "调出科室名称不能为空")
    private String srcDeptName;

    /** 外派单位 */
    @Excel(name = "外派单位")
    @NotBlank(message = "外派单位不能为空")
    ...
    public void setExpatriateReason(String expatriateReason)
    {
        this.expatriateReason = expatriateReason;
    }

    public String getExpatriateReason()
    {
        return expatriateReason;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("expatriateUnit", getExpatriateUnit())
                .append("expatriateType", getExpatriateType())
                .append("beginDate", getBeginDate())
                .append("endDate", getEndDate())
                .append("expatriateReason", getExpatriateReason())
